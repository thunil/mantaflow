...
# train a model
python modelNp.py out 0 basePath ${BPATH}  useVelocities 0  trainingEpochs 1000   alwaysSave 1  testPathStartNo 700

# and apply to small data set
python modelNp.py out 1 basePath ${BPATH}  useVelocities 0  testPathStartNo 800  fromSim 2008 toSim -1  load_model_test 700 load_model_no 0
...
python modelNp.py out 0 basePath ${BPATH}  useVelocities 1  trainingEpochs 1000  alwaysSave 1  testPathStartNo 710 

python modelNp.py out 1 basePath ${BPATH}  useVelocities 1  testPathStartNo 810  fromSim 2008 toSim -1  load_model_test 710 load_model_no 0
...
python modelUni.py out 0 basePath ${BPATH}   useVelocities 0  trainingEpochs 1000  alwaysSave 1 testPathStartNo 720
python modelUni.py out 1 basePath ${BPATH}   useVelocities 0  testPathStartNo 820  fromSim 2007 toSim -1  load_model_test 720 load_model_no 0
