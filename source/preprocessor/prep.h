...
std::string processPythonFunction(int lb, const std::string& name, const std::string& type, const ArgList& args, const std::string& initlist, bool isInline, bool isConst, const std::string& code, int line);
