...
#ifndef _GENERAL_NOPY_H
#define _GENERAL_NOPY_H
...
//#define MLOG_TAG "mantaLog"
//#define MLOGD(...) __android_log_print(ANDROID_LOG_DEBUG, MLOG_TAG, __VA_ARGS__)
//#define MLOGE(...) __android_log_print(ANDROID_LOG_ERROR, MLOG_TAG, __VA_ARGS__)
...
#   define DEBUG_ONLY(a)
#endif
#define throwError(msg)      { std::ostringstream __s; __s << msg << std::endl << "Error raised in " << __FILE__ << ":" << __LINE__; std::cerr << __s.str() <<"\n"; exit(1); }
