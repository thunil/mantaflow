#
# Flip surface mesh creation scene, note - saves & plays back meshes in UI mode
# 
from manta import *
import os
   
mantaMsg( "\nNote - this scene reads in particle data generated by, e.g., flip02_surface.py (enable line 120 there). It does not perform any fluid simulation, only generate a nicer surface.\n" )
